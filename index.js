...
bitcore.versionGuard = function(version) {
  if (version !== undefined) {
    var message = 'More than one instance of pyrkcore-lib found. ' +
      'Please make sure that you are not mixing instances of classes of the different versions of pyrkcore.';
    console.warn(message);
  }
};
bitcore.versionGuard(global._pyrkcore);
global._pyrkcore = bitcore.version;
